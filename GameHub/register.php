...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>S'inscrire - Game Hub</title>
    ...
    <?php endif; ?>
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" name="identifiant" placeholder="Entrez un identifiant" required>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        <input type="password" class="form-control" name="Motdepasse" placeholder="Définissez votre mot de passe" required>
                    </div>
                </div>
                <div class="form-group">
                    <label class="form-label">Confirmer le passe</label>
                    <div class="input-group">
                        <i class="fas fa-lock input-icon"></i>
                ...
                <button type="submit" class="btn btn-login">
                    <i class="fas fa-sign-in-alt"></i> Je m'inscris
                </button>
            </form>

            <div class="signup-link">
                J'ai déja un compte <a href="login.php">Me connecter</a>
            </div>
        </div>
    </div>
